      ...
      <div className="overflow-y-auto py-3 w-full">
        {filterUsers.map((user) => (
          <button
            ...
            className={`w-full p-3 flex items-center gap-3 hover:bg-base-300 trasition-colors ${
          ...
          >
            <div className="relative max-auto lg:mx-0">
              ...
              {onlineUsers.includes(user._id) && (
                <span className="absolute bottom-0 right-0 size-3 bg-green-500 rounded-full ring-2 ring-zinc-200"></span>
              )}
            </div>
        ...
        {filterUsers.length === 0 && (
          <div className="text-center text-secondary py-4">No Users Online</div>
        )}
      </div>
    </aside>
  );
